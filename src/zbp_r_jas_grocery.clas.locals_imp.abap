CLASS LHC_ZR_JAS_GROCERY DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
...
CLASS LHC_ZR_JAS_GROCERY IMPLEMENTATION.
  METHOD GET_GLOBAL_AUTHORIZATIONS.
  ENDMETHOD.

  METHOD checkExpirationDate.

    DATA: lt_groceries TYPE TABLE FOR READ RESULT zr_JAS_grocery,
          ls_grocery TYPE STRUCTURE FOR READ RESULT zr_JAS_grocery,
          lv_expiration TYPE d,
          lv_current_date TYPE d,
          lv_expired TYPE abap_boolean,
          lt_update_groceries TYPE TABLE FOR UPDATE zr_JAS_grocery.

    READ ENTITIES OF zr_JAS_grocery
    ...
    MODIFY ENTITIES OF zr_JAs_grocery IN LOCAL MODE
      ENTITY Grocery
